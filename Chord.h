...
//#include <iostream>
//#include "MusicalKeys.h"
////anything allocated with new is declared on the heap
//
//class Chord
//{
//private:
...
//public:
//	
//	Chord(std::vector<int>& chord_indexes_arg, MusicalKeys key_arg) :
//		chordNotes()
//	{
//		size = chord_indexes_arg.size();
//		int saveIndex = mkey::findIndex(key_arg);
//
//		/*for (int keyGenIndex = 0; keyGenIndex < chord_indexes_arg.size(); keyGenIndex++)
//		{
//
//		}*/
//
//	}
//
//	Chord(std::vector<int>& chord_indexes_arg, MajorScale& maj_scale_arg) :
//		/*chordIndexes(),*/
//		chordNotes()
//	{ 
//		size = chord_indexes_arg.size();
//		for (int noteIndex = 0; noteIndex < chord_indexes_arg.size(); noteIndex++)
//			chordNotes.push_back(maj_scale_arg[chord_indexes_arg[noteIndex]]);
//	}
//
//	const int getSize()
//	{
